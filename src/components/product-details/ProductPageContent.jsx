...
const ProductPageContent = ({ slug }) => {
  ...
  if (loading) return (
    <div className="w-full h-[75vh] min-h-[500px] mt-4 rounded-2xl overflow-hidden flex items-center justify-center">
  ...
  if (!product) return (
    <div className="h-[80vh] flex flex-col items-center justify-center text-center px-6">
      ...
      <h2 className="text-secondary dark:text-foreground text-xl font-semibold mb-2 uppercase italic tracking-tighter">
